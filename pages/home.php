<div class="py-4"> 
    ...
    <div class="row g-4 mb-5"> 
        ...
        <div class="col-md-4 col-lg-3">
            <div class="d-flex flex-column gap-3 ms-lg-5"> <div class="card border-0 shadow-sm" style="background-color: #052c65;">
        ...
        <div class="col-md-8 col-lg-8">
            <div class="ps-md-4"> <div class="d-flex align-items-center mb-3">
    ...
    <div class="row">
        <div class="col-12">
            <div class="p-4 p-md-5 bg-white rounded shadow-sm border position-relative overflow-hidden">
                <i class="fa-solid fa-bullseye position-absolute text-muted opacity-25" style="font-size: 10rem; right: -20px; bottom: -20px;"></i>
                    ...
                    <div class="col-md-4">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="text-muted small">Menyediakan pegangan praktis bagi petugas statistik lapangan dalam menghadapi kasus batas yang sering menimbulkan keraguan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="text-muted small">Menyamakan pemahaman dan interpretasi petugas, sehingga hasil pencacahan lebih konsisten dan akurat.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="text-muted small">Mempercepat proses pengambilan keputusan di lapangan dengan menghadirkan referensi yang mudah diakses secara digital.</p>
                            </div>
                        </div>
                    </div>
                </div>
