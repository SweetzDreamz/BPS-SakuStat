...
| :-------------------------------------: | :-----------------------------------------: |
| ![Home](assets/img/screenshot-home.png) | ![Search](assets/img/screenshot-search.png) |

|               Detail Kegiatan               |              Dashboard Admin              |
| :-----------------------------------------: | :---------------------------------------: |
| ![Detail](assets/img/screenshot-detail.png) | ![Admin](assets/img/screenshot-admin.png) |
