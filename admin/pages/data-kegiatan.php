                ...
                <table id="example" class="table table-striped table-bordered display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <div class="modal fade" id="edit-kegiatan<?= $data['id_kegiatan']; ?>" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="responden" class="form-control" value="<?= $data['responden']; ?>" required>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label fw-bold">Level Estimasi</label>
                                                        <select name="level_estimasi" class="form-select" required>
                                                            <option value="Kabupaten/Kota" <?= ($data['level_estimasi'] == 'Kabupaten/Kota') ? 'selected' : ''; ?>>Kabupaten/Kota</option>
                                                            <option value="Provinsi" <?= ($data['level_estimasi'] == 'Provinsi') ? 'selected' : ''; ?>>Provinsi</option>
                                                        </select>
                                                    </div>
                                                </div>
            ...
            <form action="pages/proses-kegiatan/add-data-kegiatan.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Responden</label>
                            <input type="text" name="responden" class="form-control" placeholder="Contoh: Rumah Tangga / Perusahaan" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Level Estimasi</label>
                            <select name="level_estimasi" class="form-select" required>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" name="add_kegiatan" class="btn btn-primary">Simpan Data</button>
                </div>
            </form>
        </div>
    </div>
